...
function ImgWithPortal({ className = "", img }: IProps) {
	...
	return (
		<>
			...
			<div className={`${className} group relative border border-solid border-gray-100 shadow`}>
				{
					img.match(/.mp4$/i)
					?
					<video controls width={415} height={380} src={img} className="w-full h-[380px] object-cover object-center"></video>
					:
					<>
						...
						<Image src={img} width={415} height={380} alt="preview" className="w-full h-[380px] object-cover object-center" />
					</>
				}
			</div>
		</>
